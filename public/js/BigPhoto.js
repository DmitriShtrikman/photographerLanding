Vue.component('bigphoto', {
    ...
    methods: {
        ...
        nextPhoto(){
            if (this.$parent.photoNumber < this.bigphotos.length-1) {
                this.$parent.photoNumber++
            }            
        },
        previousPhoto(){
            if (this.$parent.photoNumber > 0) {
                this.$parent.photoNumber--
            }
        },
    },
    ...
    <div id="bigphoto" class="portfolio-mosaic-item">        
        <img :src=bigphotos[this.$parent.photoNumber].img alt="portfolio-img" class="portfolio-mosaic-img">
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="" data-bs-slide="prev" @click="previousPhoto()">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="" data-bs-slide="next" @click="nextPhoto()">
